...
extern int g_steer_err_cur,g_steer_err_pre,g_steer_err_last,g_steer_err_cur,g_steer_err_pre,
            pwmtempl,pwmtempr,pwmtemp_l,pwmtemp_r,Current_speed,error,pre_error,last_error,steer_control_P,steer_control_D,PID_P,PID_D,set_speed,steer_out_this;
...
float *Parameter[16]={&steer_control_P,&steer_control_D,&PID_P,&PID_D,&set_speed,&reserve,&reserve,&reserve,&reserve,
